...
class ZSet_asInterface {
    @:keep
    public function keys():Slice<GoString> return __self__.keys();
    /**
        /|*
    ...
    **/
    @:keep
    public function zrevGetByRank(_key:GoString, _rank:GoInt):Slice<AnyInterface> return __self__.zrevGetByRank(_key, _rank);
    /**
        // ZGetByRank gets the member at key by rank, the rank is ordered from lowest to highest.
        // The rank of lowest is 0 and so on.
    **/
    @:keep
    public function zgetByRank(_key:GoString, _rank:GoInt):Slice<AnyInterface> return __self__.zgetByRank(_key, _rank);
    /**
    ...
    **/
    @:keep
    public function zrevRangeWithScores(_key:GoString, _start:GoInt, _stop:GoInt):Slice<AnyInterface> return __self__.zrevRangeWithScores(_key, _start, _stop);
    /**
        // ZRevRange returns the specified range of elements in the sorted set stored at key.
        // The elements are considered to be ordered from the highest to the lowest score.
        // Descending lexicographical order is used for elements with equal score.
    **/
    @:keep
    public function zrevRange(_key:GoString, _start:GoInt, _stop:GoInt):Slice<AnyInterface> return __self__.zrevRange(_key, _start, _stop);
    /**
        // ZRangeWithScores returns the specified range of elements in the sorted set stored at <key>.
    **/
    @:keep
    public function zrangeWithScores(_key:GoString, _start:GoInt, _stop:GoInt):Slice<AnyInterface> return __self__.zrangeWithScores(_key, _start, _stop);
    /**
        // ZRange returns the specified range of elements in the sorted set stored at <key>.
    **/
    @:keep
    public function zrange(_key:GoString, _start:GoInt, _stop:GoInt):Slice<AnyInterface> return __self__.zrange(_key, _start, _stop);
    /**
        // ZClear clear the key in zset.
    **/
    @:keep
    public function zclear(_key:GoString):Void __self__.zclear(_key);
    /**
        // ZKeyExists check if the key exists in zset.
    **/
    @:keep
    public function zkeyExists(_key:GoString):Bool return __self__.zkeyExists(_key);
    /**
    ...
    **/
    @:keep
    public function zrevScoreRange(_key:GoString, _max:GoFloat64, _min:GoFloat64):Slice<AnyInterface> return __self__.zrevScoreRange(_key, _max, _min);
    /**
    ...
    **/
    @:keep
    public function zscoreRange(_key:GoString, _min:GoFloat64, _max:GoFloat64):Slice<AnyInterface> return __self__.zscoreRange(_key, _min, _max);
    /**
        // ZRem removes the specified members from the sorted set stored at key. Non existing members are ignored.
        // An error is returned when key exists and does not hold a sorted set.
    **/
    @:keep
    public function zrem(_key:GoString, _member:GoString):Bool return __self__.zrem(_key, _member);
    /**
    ...
    **/
    @:keep
    public function zincrBy(_key:GoString, _increment:GoFloat64, _member:GoString):GoFloat64 return __self__.zincrBy(_key, _increment, _member);
    /**
    ...
    **/
    @:keep
    public function zrevRank(_key:GoString, _member:GoString):GoInt64 return __self__.zrevRank(_key, _member);
    /**
        // ZRank returns the rank of member in the sorted set stored at key, with the scores ordered from low to high.
        // The rank (or index) is 0-based, which means that the member with the lowest score has rank 0.
    **/
    @:keep
    public function zrank(_key:GoString, _member:GoString):GoInt64 return __self__.zrank(_key, _member);
    /**
        // ZCard returns the sorted set cardinality (number of elements) of the sorted set stored at key.
    **/
    @:keep
    public function zcard(_key:GoString):GoInt return __self__.zcard(_key);
    /**
        // ZScore returns the score of member in the sorted set at key.
    **/
    @:keep
    public function zscore(_key:GoString, _member:GoString):{ var _0 : Bool; var _1 : GoFloat64; } return __self__.zscore(_key, _member);
    /**
    ...
    **/
    @:keep
    public function zadd(_key:GoString, _score:GoFloat64, _member:GoString, _value:AnyInterface):GoInt return __self__.zadd(_key, _score, _member, _value);
    @:keep
    public function _exist(_key:GoString):Bool return __self__._exist(_key);
...
@:keep private class ZSet_static_extension {
    ...
    **/
    ...
    static public function zrem( _z:ZSet, _key:GoString, _member:GoString):Bool {
        ...
        var _n = _z._records[_key];
        var __tmp__ = (_n._dict != null && _n._dict.__exists__(_member) ? { value : _n._dict[_member], ok : true } : { value : (null : T_zskiplistNode), ok : false }), _v:Ref<T_zskiplistNode> = __tmp__.value, _exist:Bool = __tmp__.ok;
        if (_exist) {
    ...
    **/
    ...
    static public function zscore( _z:ZSet, _key:GoString, _member:GoString):{ var _0 : Bool; var _1 : GoFloat64; } {
        ...
        var __tmp__ = (_z._records[_key]._dict != null && _z._records[_key]._dict.__exists__(_member) ? { value : _z._records[_key]._dict[_member], ok : true } : { value : (null : T_zskiplistNode), ok : false }), _node:Ref<T_zskiplistNode> = __tmp__.value, _exist:Bool = __tmp__.ok;
        if (!_exist) {
            return { _0 : _ok, _1 : _score };
        };
...
private class T_zskiplist_asInterface {
    ...
    **/
    @:keep
    public function _getRank(_score:GoFloat64, _member:GoString):GoInt64 return __self__._getRank(_score, _member);
    /**
        /|* Delete an element with matching score/key from the skiplist. *|/
    **/
    @:keep
    public function _delete(_score:GoFloat64, _member:GoString):Void __self__._delete(_score, _member);
    /**
    ...
    **/
    ...
    static public function _getRank( _z:T_zskiplist, _score:GoFloat64, _member:GoString):GoInt64 {
        ...
        var _x = _z._head;
        {
            var _i:GoInt = _z._level - (1 : GoInt);
            Go.cfor(_i >= (0 : GoInt), _i--, {
                while ((_x._level[_i]._forward != null) && ((_x._level[_i]._forward._score < _score) || ((_x._level[_i]._forward._score == _score) && (_x._level[_i]._forward._member <= _member)))) {
...
private class T_zset_asInterface {
    @:keep
    public function _findRange(_key:GoString, _start:GoInt64, _stop:GoInt64, _reverse:Bool, _withScores:Bool):Slice<AnyInterface> return __self__._findRange(_key, _start, _stop, _reverse, _withScores);
    @:keep
    public function _getNodeByRank(_key:GoString, _rank:GoInt64, _reverse:Bool):{ var _0 : GoString; var _1 : GoFloat64; } return __self__._getNodeByRank(_key, _rank, _reverse);
    public function new(?__self__) {
        if (__self__ != null) this.__self__ = __self__;
    }
    public function __underlying__() return Go.toInterface(__self__);
