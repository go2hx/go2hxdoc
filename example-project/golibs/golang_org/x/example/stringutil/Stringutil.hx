...
function testReverse(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (_0 => _c in (new Slice<T__struct_0>(0, 0, ({ _in : (Go.str("Hello, world") : GoString), _want : (Go.str("dlrow ,olleH") : GoString) } : T__struct_0), ({ _in : (Go.str("Hello, 世界") : GoString), _want : (Go.str("界世 ,olleH") : GoString) } : T__struct_0), ({ _in : (Go.str() : GoString), _want : (Go.str() : GoString) } : T__struct_0)) : Slice<T__struct_0>)) {
