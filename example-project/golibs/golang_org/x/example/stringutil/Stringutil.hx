...
function testReverse(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_0 => _c in(new Slice<T__struct_0>(0, 0, ({_in: ("Hello, world" : GoString), _want: ("dlrow ,olleH" : GoString)} : T__struct_0),
		({_in: ("Hello, 世界" : GoString), _want: ("界世 ,olleH" : GoString)} : T__struct_0),
		({_in: Go.str(), _want: Go.str()} : T__struct_0)) : Slice<T__struct_0>)) {
